...
class GenreTableViewController: UITableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        var request = URLRequest(url: appDelegate.tmdbURLFromParameters(methodParameters as [String : AnyObject], withPathExtension: "/genre/\(genreID!)/movies"))
...
extension GenreTableViewController {
    ...
    fileprivate func genreIDFromItemTag(_ itemTag: Int) -> Int {
